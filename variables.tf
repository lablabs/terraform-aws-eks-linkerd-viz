...
variable "namespace" {
  type        = string
  default     = "linkerd-viz"
  description = "The K8s namespace in which the linkerd-viz service account has been created"
}

variable "settings" {
  type        = map(any)
  default     = {}
  description = "Additional helm sets which will be passed to the Helm chart values, see https://hub.helm.sh/charts/stable/linkerd-viz"
}

variable "values" {
  type        = string
  default     = ""
  description = "Additional yaml encoded values which will be passed to the Helm chart, see https://hub.helm.sh/charts/stable/linkerd-viz"
}
